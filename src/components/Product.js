...
export default function Product() {
  ...
  const getProduct = async ()=>{
    ...
    setProImg(`http://localhost:3000/img/products/${allproduct.imgs[0]}`)
    setLoading(false)
}
// console.log(product)
if(callproduct===true){
  ...
  return (
    ...
    {loading? 
      ...
      <div className='stars-group'>
        ...
        <p className='rating-p product-p'>No review yet. Write Review <img className='review-pen' src='http://localhost:3000/img/pen.svg' alt='write a review' onClick={review} /></p>
        </div>
      </div>
