...
export default function TrendingProducts() {
  ...
  let clearbtn = () => {
    $(".featured,.newarrivals,.bestseller").css({
      ...
      <section className="sec-b-space">
        <div className="container">
          ...
          <div className="trandingbutton mr-b-40">
            <button className="featured" onClick={featured}>
              Featured
            </button>
            <button className="newarrivals" onClick={newarrivals}>
              New Arrivals
            </button>
            <button className="bestseller" onClick={bestseller}>
              Bestseller
            </button>
          </div>
